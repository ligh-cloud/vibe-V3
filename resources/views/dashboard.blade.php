    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="relative px-6 py-8">
            ...
            <div class="text-center mt-8">
                <button id="qrCodeButton" class="bg-pink-500 text-white px-6 py-3 rounded-lg hover:bg-pink-600 transition-colors shadow-md flex items-center justify-center mx-auto">
                    <i class="fas fa-qrcode mr-2"></i> Afficher mon QR Code
                </button>
            </div>
...
<div id="qrCodeModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
        <h2 class="text-xl font-bold text-purple-800 mb-4 text-center">Votre QR Code</h2>
        <div class="flex justify-center items-center p-4 bg-gray-50 rounded-lg">
            {!! $qrCode !!}
        </div>
        <p class="text-center text-gray-600 my-3">Partagez ce QR code pour vous ajouter comme ami</p>
        <div class="mt-4 flex justify-center">
            <button id="closeQrCodeModal" class="bg-pink-500 text-white px-6 py-2 rounded-lg hover:bg-pink-600 transition-colors shadow-md">
                Fermer
            </button>
        </div>
    </div>
...
<script>
    ...
    // Open the QR code modal when the button is clicked
    qrCodeButton.addEventListener('click', () => {
        qrCodeModal.classList.remove('hidden');
    });

    // Close the QR code modal when the close button is clicked
